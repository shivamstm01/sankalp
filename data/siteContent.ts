export const siteContent = {
  contact: {
    ...
    email: "info@sankalpaayurveda.com",
  ...
  about: {
    ...
    vision: {
      title: "Our Vision",
      paragraphs: [
        "To be a centre of excellence in holistic healing of patients, research, and integrating traditional wisdom with modern scientific advancements for the well-being of society.",
        "We envision Sankalpa as a centre for cultivating wellness, advancing evidence-based Ayurveda, and inspiring a global movement towards natural and sustainable health care."
      ],
      highlight: {
        title: "Sannati Fertility and Wellness Centre",
        points: [
          "To make every couple's dream come true with healthy progeny - 'SUPRAJA'.",
          "To lead with innovation, integrity and empathy in reproductive health."
        ]
      }
    },
    mission: {
      title: "Our Mission",
      points: [
        "To deliver authentic, compassionate, and patient centered Ayurvedic care rooted in tradition and enriched with modern clinical excellence.",
        "To establish a research-driven ecosystem that validates and innovates Ayurvedic therapies for contemporary health challenges.",
        "To integrate predictive, preventive, promotive, personalised, curative, and regenerative approaches for complete well-being.",
        "To nurture the next generation of Ayurveda physicians, researchers, and healers through education, training, and experiential learning.",
        "To contribute to community health and global wellness through outreach programs, publications, and collaborations."
      ]
    },
    banner: [
      "Choose Sankalpa — Where Tradition Heals, and Research Reveals.",
      "Not just treatment, but transformation.",
      "Your Sankalpa, Our Ayurveda."
    ]
  },
  services: {
    title: {
    ...
    subtitle: "Comprehensive Ayurvedic healthcare services blending tradition with modern excellence",
    list: [
      {
    ...
    banner: {
      title: "Sannati Fertility and Wellness Centre",
      tagline: "Making every couple's dream come true with healthy progeny – 'SUPRAJA'",
      description: "Leading with innovation, integrity and empathy in reproductive health"
    }
  },
  treatments: {
    title: {
  ...
  physicians: {
    title: {
      black: "Meet Our",
      green: "Expert Physicians",
    },
    subtitle: "Experienced Ayurvedic physicians dedicated to your health and well-being",
    list: [
      {
        name: "Dr. Santrupti Katti",
    ...
    features: [
      {
        ...
        info: "Advanced degrees in Ayurveda medicine with continuous research and training",
        icon: "grad",
        color: "#008a5e"
      },
      {
        title: "Experienced Practitioners",
        info: "Decades of clinical experience treating thousands of patients successfully",
        icon: "user-check",
        color: "#f59e0b"
      },
      {
        title: "3 Generations Legacy",
        info: "Carrying forward 3 decades of authentic Ayurvedic healing tradition",
        icon: "history",
        color: "#0d9488"
      }
    ]
  ...
  footer: {
    ...
    contact: {
      phone: "+91 98765 43210",
      email: "info@sankalpaayurveda.com",
      address: "Sankalpa Ayurveda Hospital Dharwad, Karnataka, India"
    },
    hours: [
    ...
    emergency: "24/7",
    tagline: "\"Your Sankalpa, Our Ayurveda\" - Heal in Sankalpa and Heal by Sankalpa",
    copyright: "2026 Sankalpa Ayurveda Hospital & Research Centre. All rights reserved.",
    designedBy: "Newrise Technosys Pvt Ltd"
  }
};
