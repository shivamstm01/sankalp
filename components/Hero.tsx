          ...
          <div className="space-y-7 sm:space-y-8 lg:space-y-9 pt-2 sm:pt-4 lg:pt-8">
            ...
            <div className="space-y-5">
              <motion.h1 
                ...
                className="text-[36px] sm:text-[44px] md:text-[52px] lg:text-[72px] 2xl:text-[80px] font-[700] tracking-[-0.045em] leading-[1.02] lg:leading-[0.94] text-[#0f172a]"
              >
                {title.black} <br />
            ...
            >
               {stats.map((stat, idx) => (
                 <div key={idx} className="space-y-1.5">
                    <p className="text-[24px] sm:text-[28px] lg:text-[34px] font-[800] text-[#00a16a] tracking-tight">{stat.value}</p>
                    <p className="text-slate-600 text-[12px] sm:text-[13px] lg:text-[14px] leading-tight">{stat.label}</p>
                 </div>
               ))}
            </motion.div>
          </div>
