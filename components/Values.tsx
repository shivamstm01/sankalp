...
export default function Values() {
  ...
  return (
    <section id="values" className="py-20 lg:py-32 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Values Grid (Figma Solid Color Blocks) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {list.map((item, idx) => (
            <div 
              key={idx} 
              className="p-10 lg:p-12 rounded-[2rem] text-white flex flex-col gap-8 hover:scale-[1.02] transition-transform duration-500 shadow-xl"
